...
<?php
	...
	$translations_array = array(
    	'order_for_collection' => get_field('order_for_collection_text', 44) ?: 'Order For Pickup',
    	'preorder_for_collection' => get_field('preorder_for_collection_text', 44) ?: 'Preorder For Pickup',
    	'order_for_delivery' => get_field('order_for_delivery_text', 44) ?: 'Order For Delivery',
    	'preorder_for_delivery' => get_field('preorder_for_delivery_text', 44) ?: 'Preorder For Delivery',
	);
...
<body <?php body_class(); ?> data-wlid="<?php echo get_option( 'flipdish_ordering_options' )['fd_portal_id'] ?>" data-button-translations="<?php echo htmlspecialchars(json_encode($translations_array), ENT_QUOTES, 'UTF-8') ?>" data-restaurant="<?php 
$fields = "restaurants" === get_post_type() ? get_fields() : null;
echo $fields ? htmlspecialchars(json_encode($fields), ENT_QUOTES, 'UTF-8') : null ?>">
<?php
